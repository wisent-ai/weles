...
install -m 0755 "$WISENT_SOURCE_DIR/release/stado-crawler-launcher.sh" "$WISENT_OUTPUT_DIR/bin/crawler"
shasum -a 256 "$WISENT_OUTPUT_DIR/payload/weles-worker.tar.gz" "$WISENT_OUTPUT_DIR/bin/start" "$WISENT_OUTPUT_DIR/bin/crawler" > "$WISENT_OUTPUT_DIR/evidence/DIGESTS"
