// The repairs repair_strict_criteria_wsession.mjs applies: scalar fields, 6.1 tasks and 9.2 indicators.

export const scalarRepairs = [
  {
    section: '1.2',
