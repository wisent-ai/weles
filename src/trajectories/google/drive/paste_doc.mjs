...
//
// Run:
//   node weles/src/trajectories/google/drive/paste_doc.mjs \
...
const MD_TO_HTML = WELES_ROOT + '/src/lib/md_to_html.mjs';
const UPLOAD = WELES_ROOT + '/src/lib/upload_doc_api.py';
