...
import { handleCreateAccountChallenge } from '../_shared/linkedin/signup/create_account_challenge.mjs';
import { assertLinkedinDedicatedIspProxy, assertLinkedinProxyStable, assertLinkedinRegisterProxyRequest, assertNoLinkedinChallengePage, classifyLinkedinRegisterFailure, getLinkedinFailureDiagnostics, linkedinRegisterExitCode } from '../_shared/linkedin/signup/register_guard.mjs';
import { runRecordingsDir } from '../../../dist/session/run-recordings.js';
import { HEADLESS, STOP_AFTER_SIGNUP_READY, earlyFingerprintCheck, guestPrewarmUrls, registerBrowser, registerOs, registerPersona, replayWarmProfile, requestedEntryUrl, requestedProxy, safeRequestedProxy, sessionProxy, warmManifest, warmProfileDir } from './register/run_request.mjs';
import { enterLinkedinSignup, prewarmLinkedinGuestSession } from './register/signup_entry.mjs';
import { hashValue, writeSubmitDiagnostics } from './register/diagnostics.mjs';
import { linkedinFailureReasons, loadProxyPreflightSummary } from './register/refusal.mjs';
import { createLinkedinAccount } from './register/account_creation.mjs';
