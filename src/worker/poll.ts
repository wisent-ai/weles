...
async function promoteTrajectoryBuild(row: ActionLogRow, result: Record<string, unknown>): Promise<void> {
  ...
  const definition = {
    ...
    browser: textParam(params, 'browser') ?? undefined,
    os: textParam(params, 'os') ?? undefined,
    locale: textParam(params, 'locale') ?? undefined,
    session_label: textParam(params, 'session_label') ?? undefined,
