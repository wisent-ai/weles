// The analytics-service action names: the ones that resolve to one parametric
// runner instead of one trajectory each.
//
// They sit beside the resolver rather than inside it. ./dispatch.ts is the
// verb table, and a fifty-six-name membership set in the middle of it hid the
// table it belongs to.
export const ANALYTICS_SERVICE_ACTIONS = new Set([
  'umami_register',
  'umami_login',
