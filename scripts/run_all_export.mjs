...
export const TRAJECTORIES = [
  ...
  { name: 'reddit_upvote', url: 'https://www.reddit.com/login', goal: `${LOGIN} After login you will be on the Reddit homepage. Find any post and click the upvote arrow button. Do NOT use navigate(). done(value="upvoted").`, emailEnv: 'REDDIT_EMAIL', passEnv: 'REDDIT_PASSWORD' },
  { name: 'reddit_comment', url: 'https://www.reddit.com/login', goal: `${LOGIN} After login you will be on the Reddit homepage. Find any post, click on it, write a comment "Hello from weles agent" and submit. Do NOT use navigate(). done(value="commented").`, emailEnv: 'REDDIT_EMAIL', passEnv: 'REDDIT_PASSWORD' },
  { name: 'instagram_follow', url: 'https://www.instagram.com/wisent.ai/', goal: `If login required, ${LOGIN} After login, click "Follow" button. done(value="followed wisent.ai"). Do NOT use navigate().`, emailEnv: 'INSTAGRAM_EMAIL', passEnv: 'INSTAGRAM_PASSWORD' },
  { name: 'instagram_like', url: 'https://www.instagram.com/wisent.ai/', goal: `If login required, ${LOGIN} After login, find any post and click the heart/like button. done(value="liked"). Do NOT use navigate().`, emailEnv: 'INSTAGRAM_EMAIL', passEnv: 'INSTAGRAM_PASSWORD' },
  { name: 'twitter_follow', url: 'https://x.com/elonmusk', goal: `If login required, ${LOGIN} After login, click "Follow". done(value="followed @elonmusk"). Do NOT use navigate().`, emailEnv: 'TWITTER_EMAIL', passEnv: 'TWITTER_PASSWORD' },
  { name: 'twitter_like', url: 'https://x.com/', goal: `If login required, ${LOGIN} After login, find any tweet and click the heart/like button. done(value="liked"). Do NOT use navigate().`, emailEnv: 'TWITTER_EMAIL', passEnv: 'TWITTER_PASSWORD' },
  { name: 'twitter_dm', url: 'https://x.com/messages', goal: `If login required, ${LOGIN} After login, start a new message to @wisent_ai. Type "Hello from weles agent" and send. done(value="DM sent"). Do NOT use navigate().`, emailEnv: 'TWITTER_EMAIL', passEnv: 'TWITTER_PASSWORD' },
  { name: 'tiktok_follow', url: 'https://www.tiktok.com/@tiktok', goal: `If login required, ${LOGIN} After login, click "Follow". done(value="followed @tiktok"). Do NOT use navigate().`, emailEnv: 'TIKTOK_EMAIL', passEnv: 'TIKTOK_PASSWORD' },
  { name: 'tiktok_like', url: 'https://www.tiktok.com/', goal: `If login required, ${LOGIN} After login, find any video and click the heart/like button. done(value="liked"). Do NOT use navigate().`, emailEnv: 'TIKTOK_EMAIL', passEnv: 'TIKTOK_PASSWORD' },
  { name: 'github_star', url: 'https://github.com/anthropics/claude-code', goal: `If login required, ${LOGIN} After login, click "Star" button. done(value="starred anthropics/claude-code"). Do NOT use navigate().`, emailEnv: 'GITHUB_EMAIL', passEnv: 'GITHUB_PASSWORD' },
  { name: 'github_follow', url: 'https://github.com/lbartoszcze', goal: `If login required, ${LOGIN} After login, click "Follow". done(value="followed lbartoszcze"). Do NOT use navigate().`, emailEnv: 'GITHUB_EMAIL', passEnv: 'GITHUB_PASSWORD' },
];
