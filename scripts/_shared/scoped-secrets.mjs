...
const SERVICES = Object.freeze({
  ...
  appleAppStoreConnectApi: Object.freeze({ consumer: 'weles-apple-app-store-connect-api-client', item: 'api-appstoreconnect-weles', tokenFile: 'weles-apple-app-store-connect-api-client-skarbiec-token', fields: Object.freeze({ key_id: true, issuer_id: true, private_key: true }) }),
