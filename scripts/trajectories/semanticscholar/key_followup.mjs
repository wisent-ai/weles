...
const result = await runSemanticScholarKeyFollowup(sourceActionLogId || undefined, attempt);
...
if (result.status === 'needs_configuration' || result.status === 'source_not_found' || result.status === 'target_email_missing') {
