...
const t = TRAJECTORIES.find(t => t.name === 'github_login');
if (!t) { console.error('Trajectory not found: github_login'); process.exit(1); }
if (t.emailEnv) {
